    ...
    <svg aria-hidden="true" {...props}>
      <defs>
        ...
        <linearGradient id={`${id}-gradient`}>
          <stop offset="0%" stopColor="#92FEFC" />
  ...
  return (
    <section {...props}>
      <h2 className="flex items-center font-mono text-sm font-medium leading-7 text-slate-100">
        <TinyWaveFormIcon
          colors={['fill-[#FFFE8F]', 'fill-[#FE90FE]']}
...
export function Layout({ children }) {
  ...
  return (
    <>
      <header className="bg-slate-800 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
        ...
        <div className="relative z-10 px-4 pt-10 pb-4 mx-auto sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-700 lg:py-12 lg:px-8 xl:px-12">
          <Link
            href="/"
            className="relative block w-48 mx-auto overflow-hidden rounded-lg shadow-xl bg-slate-700 shadow-indigo-900/50 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
            aria-label="Homepage"
          >
            <Image
              className="w-full"
          ...
          <section className="mt-10 lg:mt-12">
            <h2 className="flex items-center font-mono text-sm font-medium leading-7 sr-only text-slate-100 lg:not-sr-only">
              <TinyWaveFormIcon
                colors={['fill-[#FE90FE]', 'fill-[#92FEFC]']}
                className="h-2.5 w-2.5"
              />
              <span className="ml-2.5">Listen</span>
            </h2>
            <div className="h-px bg-gradient-to-r from-slate-600/0 via-slate-600 to-slate-600/0 lg:hidden" />
            <ul
              role="list"
              ...
              {[
                ...
                <li key={label} className="flex">
                  <Link
                    ...
                    aria-label={label}
                  >
                    <Icon className="w-8 h-8 fill-slate-400 group-hover:fill-slate-600" />
      ...
      <main className="border-t border-slate-700 bg-slate-900 lg:relative lg:mb-28 lg:ml-112 lg:border-t-0 xl:ml-120">
        <Waveform className="absolute top-0 left-0 w-full h-20" />
        <div className="relative">{children}</div>
      </main>
      <footer className="py-10 pb-40 border-t border-slate-700 bg-slate-700 sm:py-16 sm:pb-32 lg:hidden">
        <div className="px-4 mx-auto sm:px-6 md:max-w-2xl md:px-4">
          <AboutSection />
          <h2 className="flex items-center mt-8 font-mono text-sm font-medium leading-7 text-slate-100">
