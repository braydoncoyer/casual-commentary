...
export function AudioPlayer() {
  ...
  return (
    <div className="flex items-center gap-6 px-4 py-4 shadow bg-slate-800/90 shadow-slate-100/80 ring-1 ring-slate-900/5 backdrop-blur-sm md:px-6">
      ...
      <div className="mb-[env(safe-area-inset-bottom)] flex flex-1 flex-col gap-3 overflow-hidden p-1">
        <Link
          ...
          className="text-sm font-bold leading-6 text-center truncate text-slate-100 md:text-left"
